...
class TestSP(AccountTestUsers):
    ...
    def test_invoice(self):
        ...
        ReportVatRegistry = self.env[
            "report.l10n_it_vat_registries.report_registro_iva"
        ]
        totals_registry_sp = ReportVatRegistry._compute_totals_tax(self.tax22sp, data)
        totals_registry = ReportVatRegistry._compute_totals_tax(self.tax22, data)
