    ...
    def action_move_create(self, cr, uid, ids, *args):
        ...
        for inv in self.browse(cr, uid, ids):
            ...
            if not inv.registration_date :
                ...
                self.write(cr, uid, [inv.id], {'registration_date':reg_date})
                
            if inv.registration_date and inv.date_invoice :
                if (inv.date_invoice > inv.registration_date) :
            ...
            date = inv.registration_date or inv.date_invoice or time.strftime('%Y-%m-%d')
