...
class AccountMove(models.Model):
    ...
    def _compute_l10n_it_edi_doi_warning(self):
        ...
        for move in self:
            ...
            if (
                ...
                total = f"{move.l10n_it_edi_doi_amount:.2f} {move.currency_id.symbol}"
                move.l10n_it_edi_doi_warning = self.env._(
    ...
    def action_open_declaration_of_intent(self):
        ...
        if len(declaration_ids) > 1:
            return {
                "name": self.env._("Declarations of Intent for %s", self.display_name),
                "type": "ir.actions.act_window",
                "view_mode": "list,form",
                "res_model": "l10n_it_edi_doi.declaration_of_intent",
                "domain": Domain("id", "in", declaration_ids),
            }
