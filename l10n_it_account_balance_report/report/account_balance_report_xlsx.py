...
class AccountBalanceReportXslx(models.AbstractModel):
    ...
    #     account_balance_report_xlsx_cls = super()._build_model(pool, cr)

    #     account_balance_report_xlsx_cls.workbook = None
    #     account_balance_report_xlsx_cls.data = None
    #     account_balance_report_xlsx_cls.report = None
    #     account_balance_report_xlsx_cls.lang = None
    #     account_balance_report_xlsx_cls.currency = None

    #     # Add table data
    #     account_balance_report_xlsx_cls.left_columns = None
    #     account_balance_report_xlsx_cls.right_columns = None
    #     account_balance_report_xlsx_cls.left_partner_columns = None
    #     account_balance_report_xlsx_cls.right_partner_columns = None
    #     account_balance_report_xlsx_cls.left_lines = None
    #     account_balance_report_xlsx_cls.right_lines = None

    #     # Add formats
    #     account_balance_report_xlsx_cls.format_amount_right = None
    #     account_balance_report_xlsx_cls.format_amount_bold_right = None
    #     account_balance_report_xlsx_cls.format_header_amount_right = None
    #     account_balance_report_xlsx_cls.format_title = None
    #     account_balance_report_xlsx_cls.format_filter_title = None
    #     account_balance_report_xlsx_cls.format_filter_value = None

    #     return account_balance_report_xlsx_cls
    ...
    #     report_data['format_amount_right'] = self.format_amount
    #     report_dataformat_amount_right.set_align("right")
    #     report_data['format_amount_bold_right'] = self.format_amount_bold
    #     report_dataformat_amount_bold_right.set_align("right")
