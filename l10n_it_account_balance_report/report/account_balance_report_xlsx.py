...
class AccountBalanceReportXslx(models.AbstractModel):
        ...
        * Overrides standard method *.
        ...
        return [
            ...
            (
                ...
                _("Yes") if report.trial_balance_wiz_id.foreign_currency else _("No"),
            ),
            (
                _("Limit hierarchy levels"),
                _("Level %s" % report.trial_balance_wiz_id.show_hierarchy_level)
                if report.trial_balance_wiz_id.limit_hierarchy_level
                else _("No limit"),
            ),
        ]
    ...
    def _get_report_columns(self, report):
        ...
        * Overrides standard method *.
        ...
        if report.trial_balance_wiz_id.foreign_currency:
            cols.update(
                {
                    3: {
                        "field": "currency_id",
    ...
    def get_report_lines(self, field, func=None, objects=None, report_data=None):
        ...
        if lines and report.trial_balance_wiz_id.show_partner_details:
            counter = 0
            for line in lines:
