...
class ReportAccountBalanceReport(models.TransientModel):
    ...
    def compute_data_for_report(self, tb_data):
        ...
        if not self.trial_balance_wiz_id.show_partner_details:
        ...
        if (
            self.trial_balance_wiz_id.show_partner_details
            and self.trial_balance_wiz_id.show_hierarchy
        ):
    ...
    def get_report_section(self, valid_sections, line):
        ...
        if line.get("type") == self.GROUP_TYPE:
            ...
            line.get("type") == self.ACC_TYPE
            or self.trial_balance_wiz_id.show_partner_details
        ):
    ...
    def _get_account_line_data(
        ...
        if self.trial_balance_wiz_id.show_partner_details:
    ...
    def _get_foreign_currency_data(self, data, digits):
        ...
        if self.trial_balance_wiz_id.foreign_currency:
