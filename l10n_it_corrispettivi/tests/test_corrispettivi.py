...
class TestCorrispettivi(AccountingTestCase):
    ...
    def create_corrispettivi_invoice(self):
        corr_invoice = self.invoice_model.with_context(
            default_corrispettivi=True
        ).create(
            {
    ...
    def test_corrispettivi_partner_onchange(self):
        ...
        self.assertTrue(
            self.corrispettivi_partner.property_account_position_id.corrispettivi
        )
        ...
        self.assertFalse(self.no_corrispettivi_partner.property_account_position_id)
    ...
    def test_corrispettivi_invoice_default(self):
        ...
        self.assertEqual(
            corr_invoice.partner_id.id, self.env.ref("base.public_user").partner_id.id
        )
        self.assertEqual(corr_invoice.journal_id, self.journal_model.get_corr_journal())
    ...
    def test_invoice_refund_ok(self):
        ...
        refund_invoice_dict = (
            ...
            .with_context(active_ids=corr_invoice.ids)
            .create(
                {
