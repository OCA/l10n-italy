...
accredito* deve coincidere con il *Valore accettazione*, cioè il totale della
distinta; nel *Valore tariffe banca* si indicano le eventuali spese. La
registrazione, creata nel *Registro accrediti* e confermata subito, contiene:

- in DARE il *Conto RiBa*, per l'importo accreditato;
...
- *Salvo buon fine*: la riga in DARE del *Conto RiBa* della registrazione di
  accredito;
...
gestiti come in fattura: *Importo pagato* e *Importo residuo* mostrano quanto
...
- in AVERE il *Conto RiBa* (*Salvo buon fine*) o il *Conto accettazione* (*Al
  dopo incasso*), riconciliato con la riga da incassare: il residuo della
  distinta scende come per un incasso;
...
accounts are proposed from the configuration. The *Credit Amount* has to be
equal to the *Acceptance Amount*, that is the total of the slip; the *Bank Fees
Amount* holds the fees, if any. The entry, created in the *Credit Journal* and
posted right away, has:

- in debit the *RiBa Account*, for the credited amount;
...
- *Subject To Collection*: the debit line of the *RiBa Account* in the credit
  entry;
- *After Collection*: the debit lines of the *Acceptance Account* in the
  acceptance entries.

The reconciliation is made on the total of the slip, and payments are managed
as in invoices: *Paid Amount* and *Amount Due* show how much the bank has
...
- in credit the *RiBa Account* (*Subject To Collection*) or the *Acceptance
  Account* (*After Collection*), reconciled with the line to collect: the
  amount due of the slip decreases as for a collection;
