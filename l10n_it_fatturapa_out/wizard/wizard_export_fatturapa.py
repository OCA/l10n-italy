...
class wizard_export_fatturapa(osv.osv_memory):
    ...
    def setCessionarioCommittente(self, cr, uid, partner, fatturapa,
                                  partner_address, context=None):
        fatturapa.FatturaElettronicaHeader.CessionarioCommittente = (
            CessionarioCommittenteType())
        self._setDatiAnagraficiCessionario(cr, uid, partner, fatturapa, context=context)
        self._setSedeCessionario(cr, uid, partner_address, fatturapa, context=context)
    ...
    def setFatturaElettronicaHeader(self, cr, uid, company,
                                    partner, fatturapa, partner_address,
                                    context=None):
        if context is None:
            context = {}
        fatturapa.FatturaElettronicaHeader = (
        ...
        self.setCessionarioCommittente(cr, uid, partner, fatturapa, partner_address, context=context)
    ...
    def getPartnerAddress(self, cr, uid, invoice_ids, context=None):
        if context is None:
            context = {}
    ...
    def exportFatturaPA(self, cr, uid, ids, context=None):
        ...
        for partner_id in invoices_by_partner:
            ...
            partner = self.getPartnerId(cr, uid, invoice_ids, context=context)
            partner_address = self.getPartnerAddress(cr, uid, invoice_ids,
                                                     context=context)
            if partner.is_pa:
