...
--- | --- | --- | ---
[account_vat_period_end_statement](account_vat_period_end_statement/) | 14.0.1.1.1 |  | Allow to create the 'VAT Statement'.
[assets_management](assets_management/) | 14.0.1.3.0 |  | Gestione Cespiti
...
[l10n_it_delivery_note](l10n_it_delivery_note/) | 14.0.3.1.2 | [![MarcoCalcagni](https://github.com/MarcoCalcagni.png?size=30px)](https://github.com/MarcoCalcagni) [![aleuffre](https://github.com/aleuffre.png?size=30px)](https://github.com/aleuffre) [![renda-dev](https://github.com/renda-dev.png?size=30px)](https://github.com/renda-dev) | Crea, gestisce e fattura i DDT partendo dalle consegne
