...
--- | --- | --- | ---
[account_vat_period_end_statement](account_vat_period_end_statement/) | 16.0.1.2.0 |  | Allow to create the 'VAT Statement'.
[currency_rate_update_boi](currency_rate_update_boi/) | 16.0.1.0.0 | [![eLBati](https://github.com/eLBati.png?size=30px)](https://github.com/eLBati) | Update exchange rates using www.bancaditalia.it
...
[l10n_it_account_stamp](l10n_it_account_stamp/) | 16.0.1.0.3 |  | Gestione automatica dell'imposta di bollo
...
[l10n_it_central_journal_reportlab](l10n_it_central_journal_reportlab/) | 16.0.1.0.2 | [![MarcoCalcagni](https://github.com/MarcoCalcagni.png?size=30px)](https://github.com/MarcoCalcagni) [![Borruso](https://github.com/Borruso.png?size=30px)](https://github.com/Borruso) | ITA - Libro giornale - Reportlab
[l10n_it_declaration_of_intent](l10n_it_declaration_of_intent/) | 16.0.1.0.3 |  | Gestione dichiarazioni di intento
[l10n_it_delivery_note](l10n_it_delivery_note/) | 16.0.1.2.8 | [![MarcoCalcagni](https://github.com/MarcoCalcagni.png?size=30px)](https://github.com/MarcoCalcagni) [![aleuffre](https://github.com/aleuffre.png?size=30px)](https://github.com/aleuffre) [![renda-dev](https://github.com/renda-dev.png?size=30px)](https://github.com/renda-dev) | Crea, gestisce e fattura i DDT partendo dalle consegne
...
[l10n_it_fatturapa_in](l10n_it_fatturapa_in/) | 16.0.1.0.4 |  | Ricezione fatture elettroniche
...
[l10n_it_fatturapa_out](l10n_it_fatturapa_out/) | 16.0.1.0.13 |  | Emissione fatture elettroniche
[l10n_it_fatturapa_out_di](l10n_it_fatturapa_out_di/) | 16.0.1.0.0 |  | Dichiarazioni d'intento in fatturapa
[l10n_it_fatturapa_out_oss](l10n_it_fatturapa_out_oss/) | 16.0.1.0.0 |  | OSS in fatturapa
...
[l10n_it_intrastat](l10n_it_intrastat/) | 16.0.1.0.1 |  | Riclassificazione merci e servizi per dichiarazioni Intrastat
...
[l10n_it_riba](l10n_it_riba/) | 16.0.1.2.0 |  | Ricevute bancarie
...
[l10n_it_withholding_tax_payment](l10n_it_withholding_tax_payment/) | 16.0.1.0.2 |  | Gestisce le ritenute sulle fatture e sui pagamenti
