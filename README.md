...
--- | --- | --- | ---
[account_vat_period_end_statement](account_vat_period_end_statement/) | 16.0.1.0.1 |  | Allow to create the 'VAT Statement'.
...
[l10n_it_account_stamp](l10n_it_account_stamp/) | 16.0.1.0.0 |  | Gestione automatica dell'imposta di bollo
...
[l10n_it_delivery_note](l10n_it_delivery_note/) | 16.0.1.0.1 | [![As400it](https://github.com/As400it.png?size=30px)](https://github.com/As400it) | Crea, gestisce e fattura i DDT partendo dalle consegne
...
[l10n_it_fatturapa](l10n_it_fatturapa/) | 16.0.1.0.1 |  | Fatture elettroniche
[l10n_it_fatturapa_out](l10n_it_fatturapa_out/) | 16.0.1.0.4 |  | Emissione fatture elettroniche
...
[l10n_it_website_portal_ipa](l10n_it_website_portal_ipa/) | 16.0.1.0.0 |  | Aggiunge l'indice PA (IPA) tra i dettagli dell'utente nel portale.
[l10n_it_withholding_tax](l10n_it_withholding_tax/) | 16.0.1.1.0 |  | ITA - Ritenute d'acconto
