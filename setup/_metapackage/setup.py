...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo12-addon-l10n_it_fatturapa_out_di',
        'odoo12-addon-l10n_it_fatturapa_out_fd',
        'odoo12-addon-l10n_it_fatturapa_out_oss',
