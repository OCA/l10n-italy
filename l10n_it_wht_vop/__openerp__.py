...
Questo modulo permette di generare le corrette registrazioni contabili quando
si utilizzano entrambi i moduli di IVA per cassa (account_vat_on_payment)
e ritenute d'acconto (l10n_it_withholding_tax)
