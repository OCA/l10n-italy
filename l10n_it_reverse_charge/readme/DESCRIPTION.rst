...
Inoltre ?? automatizzata la procedura di annullamento e riapertura della fattura fornitore.

?? inoltre possibile utilizzare la modalit?? "con autofattura fornitore aggiuntiva".
Questa modalit?? ?? usata tipicamente per i fornitori extra UE per mostrare, nel registro IVA acquisti, una fattura intestata alla propria azienda (autofattura passiva).
L'autofattura passiva verr?? poi totalmente riconciliata con l'autofattura attiva, anch'essa intestata alla propria azienda.
