...
from odoo.addons.l10n_it_fatturapa.bindings.fatturapa import AltriDatiGestionaliType
...
class WizardExportFatturapa(models.TransientModel):
    ...
    def setDatiRiepilogo(self, invoice, body):
        ...
        for line in invoice.invoice_line_ids:
            if any(y.oss_country_id and y.kind_id for y in line.invoice_line_tax_ids):
                ...
                body.DatiBeniServizi.DatiRiepilogo[
                    0
                ].RiferimentoNormativo = encode_for_export(
