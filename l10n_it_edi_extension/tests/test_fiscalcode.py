...
class TestFiscalCode(TransactionCase):
    ...
    def test_fiscalcode_compute(self):
        ...
        # ---- Compute FiscalCode
        wizard.compute_fc()
        self.assertEqual(self.partner.l10n_it_codice_fiscale, "RSSMRA84H04H501X")
            ...
            self.env["res.partner"].create(
                {
                    "name": "Person",
                    "is_company": False,
                    "l10n_it_codice_fiscale": "AAAMRA00H04H5010",
                }
            )
    ...
    def test_fiscal_code_check_change_to_person(self):
        ...
        # pre-condition
        self.assertFalse(isvalid(wrong_person_fiscalcode))

        with self.assertRaises(UserError) as ue:
            partner.l10n_it_codice_fiscale = wrong_person_fiscalcode
        exc_message = ue.exception.args[0]

        # Assert
        self.assertIn("Invalid Codice Fiscale", exc_message)
    ...
    def test_fiscal_code_check_company_VAT_change_to_person(self):
        ...
        partner.l10n_it_codice_fiscale = company_vat
        # pre-condition
        self.assertFalse(isvalid(partner.l10n_it_codice_fiscale))
