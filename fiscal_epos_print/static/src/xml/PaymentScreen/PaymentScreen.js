    ...
    const MyPaymentScreen = (PaymentScreen) =>
        class extends PaymentScreen {
            ...
            sendToFP90Printer(receipt, printer_options) {
                ...
                // This causes payment split issues?! Reloading old order, with already billed lines??
                // TODO: Proof of concept without this line
                // this.env.pos.context = {};
            }

            // Old implementation - fully synchronous and without fiscal data retrieval
            ...
            // New implementation - fully asynchronous and with fiscal data retrieval
            // It avoids posting an order to odoo without printed fiscal receipt
            async _finalizeValidation() {
                ...
                if (!order || !order.is_paid()) {
                    this.showPopup("ErrorPopup", {
                        ...
                        body: _t("Please enter full payment."),
                    });
                    return;
                }
