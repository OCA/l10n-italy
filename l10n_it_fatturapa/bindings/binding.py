...
NaturaType.N2_1 = NaturaType._CF_enumeration.addEnumeration(unicode_value='2.1', tag='2.1')
NaturaType.N2_2 = NaturaType._CF_enumeration.addEnumeration(unicode_value='2.2', tag='2.2')
NaturaType.N3_1 = NaturaType._CF_enumeration.addEnumeration(unicode_value='3.1', tag='3.1')
NaturaType.N3_2 = NaturaType._CF_enumeration.addEnumeration(unicode_value='3.2', tag='3.2')
NaturaType.N3_3 = NaturaType._CF_enumeration.addEnumeration(unicode_value='3.3', tag='3.3')
NaturaType.N3_4 = NaturaType._CF_enumeration.addEnumeration(unicode_value='3.4', tag='3.4')
NaturaType.N3_5 = NaturaType._CF_enumeration.addEnumeration(unicode_value='3.5', tag='3.5')
NaturaType.N3_6 = NaturaType._CF_enumeration.addEnumeration(unicode_value='3.6', tag='3.6')
NaturaType.N6_1 = NaturaType._CF_enumeration.addEnumeration(unicode_value='6.1', tag='6.1')
NaturaType.N6_2 = NaturaType._CF_enumeration.addEnumeration(unicode_value='6.2', tag='6.2')
NaturaType.N6_3 = NaturaType._CF_enumeration.addEnumeration(unicode_value='6.3', tag='6.3')
NaturaType.N6_4 = NaturaType._CF_enumeration.addEnumeration(unicode_value='6.4', tag='6.4')
NaturaType.N6_5 = NaturaType._CF_enumeration.addEnumeration(unicode_value='6.5', tag='6.5')
NaturaType.N6_6 = NaturaType._CF_enumeration.addEnumeration(unicode_value='6.6', tag='6.6')
NaturaType.N6_7 = NaturaType._CF_enumeration.addEnumeration(unicode_value='6.7', tag='6.7')
NaturaType.N6_8 = NaturaType._CF_enumeration.addEnumeration(unicode_value='6.8', tag='6.8')
NaturaType.N6_9 = NaturaType._CF_enumeration.addEnumeration(unicode_value='6.9', tag='6.9')
