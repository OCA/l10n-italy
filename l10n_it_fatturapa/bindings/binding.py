...
# Atomic simple type: {http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2}EmailContattiType
class EmailContattiType (pyxb.binding.datatypes.string):
...
EmailContattiType._CF_pattern = pyxb.binding.facets.CF_pattern()
EmailContattiType._CF_pattern.addPattern(pattern='.+@.+[.]+.+')
EmailContattiType._InitializeFacetMap(EmailContattiType._CF_minLength,
   EmailContattiType._CF_maxLength,
   EmailContattiType._CF_pattern)
Namespace.addCategoryObject('typeBinding', 'EmailContattiType', EmailContattiType)
_module_typeBindings.EmailContattiType = EmailContattiType
