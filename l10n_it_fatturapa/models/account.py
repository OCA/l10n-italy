...
class FatturapaPaymentDetail(orm.Model):
    ...
    _columns = {
        ...
        'recepit_name': fields.char("Recepit payment partner contact", size=32),
        'recepit_surname': fields.char("Recepit payment partner contact", size=32),
        'recepit_cf': fields.char("Recepit payment partner contact", size=16),
        'recepit_title': fields.char("Recepit payment partner contact", size=8),
        'payment_bank_name': fields.char("Bank name", size=100),
        'payment_bank_iban': fields.char("IBAN", size=20),
        'payment_bank_abi': fields.char("ABI", size=8),
        'payment_bank_cab': fields.char("CAB", size=8),
        'payment_bank_bic': fields.char("BIC", size=38),
        ...
        'payment_code': fields.char('Payment code', size=16),
...
class AccountInvoice(orm.Model):
    ...
    _columns = {
        ...
        'ftpa_incoterms': fields.char(string="Incoterms", copy=False, size=32),

        #  2.1.10
        'related_invoice_code': fields.char('Related invoice code', size=32),
    ...
    'efatt_stabile_organizzazione_indirizzo': fields.char(
        ...
        help="Blocco da valorizzare nei casi di cedente / prestatore non "
             ...
             "etc.)",
        readonly=True, copy=False, size=100),
    ...
    'efatt_stabile_organizzazione_comune': fields.char(
        ...
        readonly=True, copy=False, size=16),
    'efatt_stabile_organizzazione_provincia': fields.char(
        ...
        readonly=True, copy=False, size=2),
