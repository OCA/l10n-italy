...
class res_partner(osv.osv):
    ...
    def _leggicodicicomuni(self, nomefile):
    ...
    CODICICOMUNI=_leggicodicicomuni('codicicomuni.txt')
    ...
    def _datan(self, giorno, mese, anno, sesso):
