        ...
        self.asset_category_1 = self.env["asset.category"].create(
            {
                ...
                "asset_account_id": self.env["account.account"]
                .search(
                    [
                        (
                            "user_type_id",
                ...
                .id,
                "depreciation_account_id": self.env["account.account"]
                .search(
                    [
                        (
                            "user_type_id",
                ...
                .id,
                "fund_account_id": self.env["account.account"]
                .search(
                    [
                        (
                            "user_type_id",
                ...
                .id,
                "gain_account_id": self.env["account.account"]
                .search(
                    [
                        (
                            "user_type_id",
                ...
                .id,
                "loss_account_id": self.env["account.account"]
                .search(
                    [
                        (
                            "user_type_id",
        ...
        self.env["asset.category.depreciation.type"].create(
            {
                ...
                "mode_id": self.env.ref("assets_management.ad_mode_materiale").id,
            }
        )
