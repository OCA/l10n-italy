...
class FatturhelloConnector(models.AbstractModel):
    _name = "l10n_it_edi_fatturhello.connector"
    ...
    def _get_company_data(self, company, companies_data):
        ...
        ."""
        company.ensure_one()
        company_vat, company_fc = company.vat, company.l10n_it_codice_fiscale
    ...
    def _prepare_move_upload_values(self, upload_result):
    ...
    def upload_e_invoice(
        self, base_url, session_token, company_identifier, move, file_name, file_content
    ):
        ...
        move.update(self._prepare_move_upload_values(upload_result))
