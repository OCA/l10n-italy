...
class WizardExportFatturapa(models.TransientModel):
    ...
    def setDatiGeneraliDocumento(self, invoice, body):
        ...
        if (
            invoice.rc_purchase_invoice_id
            and invoice.rc_purchase_invoice_id.fiscal_position_id
            and invoice.rc_purchase_invoice_id.fiscal_position_id.rc_type_id
            and invoice.rc_purchase_invoice_id.fiscal_position_id.rc_type_id.fiscal_document_type_id
        ):
            body.DatiGenerali.DatiGeneraliDocumento.TipoDocumento = (
                invoice.rc_purchase_invoice_id.fiscal_position_id.rc_type_id.fiscal_document_type_id.code
            )
        if (
            invoice.type
            in [
    ...
    def setDettaglioLinea(self, line_no, line, body, price_precision, uom_precision):
        ...
        if (
            ...
            and line.invoice_id.fiscal_document_type_id.code not in ["TD04", "TD08"]
        ):
