...
class TestReverseCharge(ReverseChargeCommon, FatturaPACommon):
    def setUp(self):
        ...
        self.sale_invoice_line_account = (
            self.env["account.account"]
            .search(
                [
                    (
        ...
        self.purchase_invoice_line_account = (
            self.env["account.account"]
            .search(
                [
                    (
    ...
    def test_intra_EU_supplier_refund(self):
        ...
        self.assertEqual(invoice.fiscal_document_type_id.code, "TD04")
        invoice_line_vals = {
            "name": "Invoice for sample product",
