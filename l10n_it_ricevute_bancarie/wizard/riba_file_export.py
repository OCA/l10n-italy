...
class riba_file_export(orm.TransientModel):
    ...
    def _Record14(
        self, scadenza, importo, abi_assuntrice, cab_assuntrice,
        conto, abi_domiciliataria, cab_domiciliataria, sia_credit,
        codice_cliente
    ):
    ...
    def _Record20(
        ...
        return " 20" + str(self._progressivo).rjust(7, '0') + self._creditore[
            0:24] + indirizzo_creditore.ljust(24)[
            0:24] + cap_citta_creditore.ljust(24)[0:24] + ref_creditore.ljust(
            24)[0:24] + " " * 14 + "\r\n"

    def _Record30(self, nome_debitore, codice_fiscale_debitore):
        return " 30" + str(self._progressivo).rjust(
            7, '0') + nome_debitore.ljust(60)[
            0:60] + codice_fiscale_debitore.ljust(16, ' ') + " " * 34 + "\r\n"
    ...
    def _Record50(
        ...
        self._descrizione = (
            'PER LA FATTURA N. ' + invoice_ref + ' DEL ' + data_invoice
            + ' IMP ' + str(importo_debito))
        return " 50" + str(self._progressivo).rjust(
            7, '0') + self._descrizione.ljust(
            80)[0:80] + " " * 10 + partita_iva_creditore.ljust(
            16, ' ') + " " * 4 + "\r\n"
    ...
    def _RecordEF(self):  # record di coda
        return (
            ...
            + self._supporto + " " * 6 + str(self._progressivo).rjust(7, '0')
    ...
    def _creaFile(self, intestazione, ricevute_bancarie):
        ...
        for value in ricevute_bancarie:  # estraggo le ricevute dall'array
            ...
            accumulatore = accumulatore + self._Record20(
                intestazione[7], intestazione[8], intestazione[9],
                intestazione[10])
    ...
    def act_getfile(self, cr, uid, ids, context=None):
        ...
        if (
            ...
            raise orm.except_orm(
                'Error', _('No VAT or Fiscalcode specified for: ')
                + name_company)
        array_testata = [
            credit_sia,
            credit_abi,
