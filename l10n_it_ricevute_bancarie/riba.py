...
class riba_distinta(orm.Model):
    ...
    def _get_acceptance_move_ids(self, cr, uid, ids, field_name, arg, context):
        ...
        for distinta in self.browse(cr, uid, ids, context=context):
            ...
            for line in distinta.line_ids:
                if (
                    line.acceptance_move_id and line.acceptance_move_id.id
                    not in move_ids
                ):
    ...
    _defaults = {
        ...
        'company_id': lambda self, cr, uid, c: self.pool.get(
            ...
            cr, uid, 'riba.distinta', context=c),
    }
...
class riba_distinta_line(orm.Model):
    ...
    def move_line_id_payment_gets(self, cr, uid, ids, *args):
        ...
        cr.execute("""SELECT distinta_line.id, l.id
                   ...
                   LEFT JOIN riba_distinta_line distinta_line
                   ON (distinta_line.acceptance_move_id=l.move_id)
    ...
    # TODO estendere la account_due_list per visualizzare e
    # filtrare in base alle riba ?
    ...
    _columns = {
        ...
        'partner_id': fields.many2one(
            'res.partner', "Cliente", readonly=True),
        ...
        'reconciled': fields.function(
            ...
            }, help="""It indicates that the line has been paid and the
                    journalentry of the line has been reconciled with one or
