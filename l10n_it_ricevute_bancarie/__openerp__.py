...
è necessario specificare almeno il sezionale ed il conto da utilizzare al
momento dell'accettazione della distinta da parte della banca.
...
all'insoluto verrà utilizzato in caso di mancato pagamento da parte del
cliente.
...
abbiamo un esempio delle tipiche registrazioni generate da un flusso
'salvo buon fine'.
""",
    'images': [],
    'depends': [
