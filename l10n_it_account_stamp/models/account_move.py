...
class AccountMove(models.Model):
        ...
        total_tax_base = sum(
            (
                ...
                for inv_tax in self.line_ids.filtered(
                    ...
                    & set(stamp_product_id.l10n_it_account_stamp_stamp_duty_apply_tax_ids.ids)
                )
            ),
            0.0,
        )
        return total_tax_base >= stamp_product_id.l10n_it_account_stamp_tax_apply_min_total_base
    ...
    def _compute_l10n_it_account_stamp_is_stamp_duty_applied(self):
        for invoice in self:
            ...
            if invoice.l10n_it_account_stamp_auto_compute_stamp_duty:
                invoice.l10n_it_account_stamp_is_stamp_duty_applied = invoice.is_stamp_duty_applicable()
            else:
    ...
    def _compute_l10n_it_account_stamp_is_stamp_duty_present(self):
        for invoice in self:
            invoice.l10n_it_account_stamp_is_stamp_duty_present = invoice.is_stamp_duty_line_present()
