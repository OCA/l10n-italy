...
class AccountMove(models.Model):
        ...
        total_tax_base = sum(
            (
                ...
                for inv_tax in self.line_ids.filtered(
                    ...
                    & set(stamp_product_id.l10n_it_account_stamp_tax_stamp_apply_tax_ids.ids)
                )
            ),
            0.0,
        )
    ...
    def _compute_l10n_it_account_stamp_is_tax_stamp_applied(self):
        for invoice in self:
            ...
            if invoice.l10n_it_account_stamp_auto_compute_tax_stamp:
                invoice.l10n_it_account_stamp_is_tax_stamp_applied = invoice.is_tax_stamp_applicable()
            else:
    ...
    def _compute_l10n_it_account_stamp_is_tax_stamp_present(self):
        for invoice in self:
            invoice.l10n_it_account_stamp_is_tax_stamp_present = invoice.is_tax_stamp_line_present()
