...
class ProductTemplate(models.Model):
    ...
    @api.constrains("l10n_it_account_stamp_stamp_duty_apply_tax_ids", "l10n_it_account_stamp_is_stamp")
    def _check_stamp_apply_tax(self):
        for template in self:
            if template.l10n_it_account_stamp_stamp_duty_apply_tax_ids and not template.l10n_it_account_stamp_is_stamp:
