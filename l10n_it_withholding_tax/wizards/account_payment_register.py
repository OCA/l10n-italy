...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _create_payment_vals_from_wizard(self):
        ...
        withholding_amount = sum(self.mapped("line_ids.withholding_tax_amount") or [])
        if withholding_amount:
            ...
            if self.source_currency_id == self.currency_id and (
                ...
                payment_difference = (
                    self.source_amount_currency - withholding_amount - self.amount
                )
                ...
                payment_difference = (
                    self.source_amount - withholding_amount - self.amount
                )
            if (
