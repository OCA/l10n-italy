...
#        fiscalyear_id = fyc.closing_fiscalyear_id.id
        ...
        if operation == 'loss_and_profit':
            ...
            if not fyc.lp_description:
                raise orm.except_orm(_('UserError'), _("The L&P description must be defined"))
            if not fyc.lp_date:
                raise orm.except_orm(_('UserError'), _("The L&P date must be defined"))
            if not (fyc.lp_period_id and fyc.lp_period_id.id):
                raise orm.except_orm(_('UserError'), _("The L&P period must be defined"))
            if not (fyc.lp_journal_id and fyc.lp_journal_id.id):
                raise orm.except_orm(_('UserError'), _("The L&P journal must be defined"))
            ...
            if not fyc.nlp_description:
                raise orm.except_orm(_('UserError'), _("The Net L&P description must be defined"))
            if not fyc.nlp_date:
                raise orm.except_orm(_('UserError'), _("The Net L&P date must be defined"))
            if not (fyc.nlp_period_id and fyc.nlp_period_id.id):
                raise orm.except_orm(_('UserError'), _("The Net L&P period must be defined"))
            if not (fyc.nlp_journal_id and fyc.nlp_journal_id.id):
                raise orm.except_orm(_('UserError'), _("The Net L&P journal must be defined"))
            ...
            if not (fyc.loss_and_profit_move_id and fyc.loss_and_profit_move_id.id):
                raise orm.except_orm(_('UserError'), _("The L&P move must exist before creating the closing one"))
            '''
            #
            ...
            if not fyc.c_description:
                raise orm.except_orm(_('UserError'), _("The closing description must be defined"))
            if not fyc.c_date:
                raise orm.except_orm(_('UserError'), _("The closing date must be defined"))
            if not (fyc.c_period_id and fyc.c_period_id.id):
                raise orm.except_orm(_('UserError'), _("The closing period must be defined"))
            if not (fyc.c_journal_id and fyc.c_journal_id.id):
                raise orm.except_orm(_('UserError'), _("The closing journal must be defined"))
    ...
    def create_opening_move(self, cr, uid, operation, fyc, context):
        ...
        if operation == 'open':
            ...
            if not (closing_move and closing_move.id):
                raise orm.except_orm(_('UserError'), _("The closing move must exist to create the opening one"))
            if not closing_move.line_id:
                raise orm.except_orm(_('UserError'), _("The closing move shouldn't be empty"))
            #
            # Get the values for the lines
            #
            if not fyc.o_description:
                raise orm.except_orm(_('UserError'), _("The opening description must be defined"))
            if not fyc.o_date:
                raise orm.except_orm(_('UserError'), _("The opening date must be defined"))
            if not (fyc.o_period_id and fyc.o_period_id.id):
                raise orm.except_orm(_('UserError'), _("The opening period must be defined"))
            if not (fyc.o_journal_id and fyc.o_journal_id.id):
                raise orm.except_orm(_('UserError'), _("The opening journal must be defined"))
