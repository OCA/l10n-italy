...
class SaleCommissionMakeSettle(models.TransientModel):
    ...
    def _get_agent_lines(self, agent, date_to_agent):
        ...
        """
        # rimuove le righe delle fatture che hanno impostato flag "no_commission"
        # e che abbiano Ri.Ba come metodo di pagamento da quelle recuperate
        # con il metodo originale
        agent_lines = (
            super()
