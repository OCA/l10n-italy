...
provvigioni agente solamente trascorso il numero di giorni impostati nel campo 
...
agent commissions only after the number of days set in the field "Safety Days" 
