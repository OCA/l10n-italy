...
provvigioni agente solamente trascorsi il numero di giorni impostati nel campo 
...
Richiede almeno la versione 14.0.1.5.2 del modulo ``sale_commission``
(https://github.com/OCA/commission/tree/14.0/sale_commission).
...
It needs at least 14.0.1.5.2 version of ``sale_commission`` module
(https://github.com/OCA/commission/tree/14.0/sale_commission).
